        ...
        if (pAnswer.equalsIgnoreCase("Yes")) {
            ...
            do {
                ...
                if (pAnswer.equalsIgnoreCase("Hit")) {
                    ...
                    if (me.getHandSum() > 21) {
                        System.out.println("You hit and got a total of " + me.getHandSum() + ". You busted and Dealer wins! ");
                        System.exit(0);
                    }
                }
                //STAY
            ...
            do {
                ...
                if (dealer.getHandSum() <= 15) {
                    ...
                    if (dealer.getHandSum() > 21) {
                        System.out.println("Dealer busted and got a total of " + dealer.getHandSum() + ". " + "You win!");
                        System.exit(0);
                    }
                } else {
