...
public class TicTacToe {
    ...
    public static int[] parseInput(String answer) {
        if (answer.toUpperCase().equals("A1")) {
            return new int[]{0, 0};
        } else if (answer.toUpperCase().equals("A2")) {
            return new int[]{1, 0};
        } else if (answer.toUpperCase().equals("A3")) {
            return new int[]{2, 0};
        } else if (answer.toUpperCase().equals("B1")) {
            return new int[]{0, 1};
        } else if (answer.toUpperCase().equals("B2")) {
            return new int[]{1, 1};
        } else if (answer.toUpperCase().equals("B3")) {
            return new int[]{2, 1};
        } else if (answer.toUpperCase().equals("C1")) {
            return new int[]{0, 2};
        } else if (answer.toUpperCase().equals("C2")) {
            return new int[]{1, 2};
        } else if (answer.toUpperCase().equals("C3")) {
            return new int[]{2, 2};
        } else {
            return null;
        }
    ...
    public static boolean tryAgain() {
        ...
        if (reply.toUpperCase().equals("YES")) {
            return true;
        } else if (reply.toUpperCase().equals("NO")) {
            return false;
        }
        return true;
    }
